...
filenameGridded = "testRepICGriddedStruct/heterogeneous.h5"
filenameIndexed = "testRepICCellIDStruc_16x16x16/heterogeneous.h5"
...
with h5py.File(filenameGridded, "r+") as f:
    ...
    presGridded = np.array(f[index_string], '=f8')
...
with h5py.File(filenameIndexed, "r+") as f:
    ...
    index_string = 'Time:  0.00000E+00 d/Liquid_Pressure [Pa]'
    presInd = np.array(f[index_string], '=f8')
...
print(diffPoro.max())
diffPres = abs(presGridded - presInd)
print(diffPoro.max())
tol = 1e-6
